...
// Declare an IMU structure with members: angular velocity, linear acceleration and quaternion
// struct IMU
// {
...
struct ROSImuSubscriber : public ROSSubscriber<sensor_msgs::Imu, sva::MotionVecd>
{
  ROSImuSubscriber()
  : ROSSubscriber([](const sensor_msgs::Imu & msg) {
